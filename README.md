...
| 模块启停、自动回复、转发、复读、24 点、定时任务 | 模块中心 |
| AI Provider、模型列表、API Key、路由标签和 AI 指令模板 | AI 中心 / 模块中心 |
| 普通 Bot Token、群互动 Bot、授权用户 | 账号详情 → Bot |
| 远程模块安装、更新、账号级启用和配置 | 模块中心 → 安装模块 |
...
<details>
<summary><strong>模块开发、安全边界与验证命令</strong></summary>
